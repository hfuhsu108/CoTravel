...
const ICONS = {
  ...
  hotel: { solid: faHotel },
  // 書籤清單擴充圖示
  wine: { solid: faWineGlass },
  icecream: { solid: faIceCream },
  pizza: { solid: faPizzaSlice },
  bowl: { solid: faBowlFood },
  tree: { solid: faTree },
  water: { solid: faWater },
  camp: { solid: faCampground },
  seedling: { solid: faSeedling },
  landmark: { solid: faLandmark },
  torii: { solid: faToriiGate },
  monument: { solid: faMonument },
  museum: { solid: faBuildingColumns },
  palette: { solid: faPalette },
  shopping: { solid: faBagShopping },
  gift: { solid: faGift },
  gem: { solid: faGem },
  spa: { solid: faSpa },
  tent: { solid: faTent },
  ferry: { solid: faFerry },
  bicycle: { solid: faBicycle },
  cameraRetro: { solid: faCameraRetro },
  panorama: { solid: faPanorama },
  binoculars: { solid: faBinoculars },
  flag: { solid: faFlag },
  compass: { solid: faCompass },
