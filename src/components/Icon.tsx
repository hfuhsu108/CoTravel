...
const ICONS = {
  ...
  walk: (
    <>
      ...
      <path d="M11 21l1.5-6-2.5-2 1-5 3 2 2 1M9.5 11 8 21" />
    </>
  ),
  train: (
    <>
      <rect x="6" y="3" width="12" height="14" rx="3" />
      <path d="M6 12h12M9 21l-2-3M15 21l2-3" />
    </>
  ),
  car: (
    <>
  ...
  bed: (
    <>
      <path d="M3 18v-6h18v6M3 12V8a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v1h4V8a2 2 0 0 1 2-2h3" />
